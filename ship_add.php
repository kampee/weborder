...
while ( $w1 = mysql_fetch_array( $r1 ) ) 
{
	...
	$cr_acc=$w1[cr_acc];
?>
<table cellspacing=1 cellpadding=1 border=0 width="100%" bgcolor="white">
<tr>
	<td>
		<FONT face="arial,MS Sans Serif, Microsoft Sans Serif"  size="2"><b>
		<?php
		if($cnt_x==1)
		{
			$make_select_x="CHECKED";
		}
		else
		{
			$make_select_x="";
		...
		?>
		<INPUT TYPE="radio" NAME="ship_add" value="<?php echo $aid; ?>" <?php echo $make_select_x; ?>>
