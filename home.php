...
<tr bordercolordark="#ffffff" bordercolorlight="silver" valign="middle">
	<td bgcolor="EEEEDD" height="30">
		...
		<SELECT NAME="pgroup" CLASS="addcart" onChange="location =options[selectedIndex].value">
			...
			{
				case "11": //CWF
					$wh="where pcwf_flag='1'";
					break;
				case "12": //WWK
					$wh="where pwwk_flag='1'";
					break;
				default:
					$wh="";
			}

			$queryt="select * from $wb_tbl_pgroup ".$wh;
...
<tr valign="top">
	<td width="150">
		...
		<!--&nbsp;&nbsp;<a href="javascript:alert('Module not installed');"><font face="arial" size="1">Privacy Policy</font></a>-->
	</td>
	...
	<td width="600" bgcolor="white">
		...
		<tr bordercolordark="#ffffff" bordercolorlight="silver" valign="middle">
			<td bgcolor="EEEEDD">
				...
				<font face="arial" size="2" color="<?php echo $fc_wel_color; ?>">
				&nbsp; <b><?php echo _welcome_txt; ?>, </b><?php echo $session_real; ?> 
				
				<!--
				<font color="#FFCC00">@<b><?php echo $session_cname; ?></b></font>
				-->
