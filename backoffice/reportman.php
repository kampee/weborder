...
<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
	...
	<td bgcolor="white" height="25">
		...
		&nbsp; <INPUT TYPE="text" NAME="start_date" size="12" class="bkoffice" value="<?php echo $st_global_date; ?>">&nbsp;<a href="javascript:void(0)" onClick="javascript:popUpCalendar(this, form1.start_date, 'yyyy/mm/dd');"><img src="includes/popup-calendar/images/cal.gif" border=0 width="16"></a>
		</font>
	</td>
	<td bgcolor="EEEEDD" height="25">
		<font face="arial" size="2">
	...
	<td bgcolor="white" height="25">
		<font face="arial" size="2" color="gray">
		&nbsp; <INPUT TYPE="text" NAME="end_date" size="12" class="bkoffice" value="<?php echo $regdate; ?>">&nbsp;<a href="javascript:void(0)" onClick="javascript:popUpCalendar(this, form1.end_date, 'yyyy/mm/dd');"><img src="includes/popup-calendar/images/cal.gif" border=0 width="16"></a>
		</font>
	</td>
</tr>
...
<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
	...
	<td bgcolor="white" height="20" colspan=3>
		...
		<select name="bbn" class="bkoffice">
			...
			<?php
			$queryf="select * from $wb_tbl_users where cid='$session_cid' and flag_del=0 order by ufname";
...
<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
	<td bgcolor="EEEEDD" height="25" colspan="4" align="center">
		<font face="arial" size="2">
		<INPUT TYPE="submit" value="Run Query" class="bkoffice">
		</font>
	</td>
</tr>
</form>
...
<TABLE cellSpacing="2" cellPadding="2" width="100%" bgColor="white" border="0" align="center">
	...
	<TR VALIGN="MIDDLE" BGCOLOR="<?php echo $bgcol; ?>">
		...
		<TD>
			...
			&nbsp; 
			<?php
				echo "<a href=\"vieworder.php?order_id=$row[order_id]&rd=".rand()."&sid=$row[order_sid]\" target=\"_blank\">$row[os_code]</a>";
