...
else
{
	...
	$_SESSION['AntiSpamImage'] = rand(1,9999999);
		...
		$headers = $mailFrom;
		$mailme="info@vanusnun.com,nuk_t@hotmail.com";
		//$mailme="kampee@siamesenet.com,kampee@gmail.com";
		$mailsub=$subject;
		...
		{
			AlertMsg("Your Messages has been sent to us. We will reply you as soon, Thank you.","contactus.php");
			//$ErrMess="Your Messages has been sent to us. We will reply you as soon, Thank you. <br><a href=\"index.html\">Back Home</a>";
		}
		else
		{
			//$ErrMess="Your Messages couldn't send, Please try again";
			AlertMsg("Your Messages couldn't send, Please try again","contactus.php");
		}
}
