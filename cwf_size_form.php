...
<form action="cwf_size_form.php?cart_id=<?php echo $cart_id; ?>&cart_qty=<?php echo $cart_qty; ?>&pid=<?php echo $pid; ?>&act=update" method="post">
...
<tr bordercolordark="#ffffff" bordercolorlight="silver" valign="middle">
	<td bgcolor="EEEEDD" height="20">
		...
		if ($fchk>0) 
		{
			include("cwf_size_form_edit.php");
		}
		else
		{
			include("cwf_size_form_add.php");
		}
		?>
...
if($act=="update")
{
	...
	AlertMsg("Size label variables has been updated.","cwf_size_form.php?cart_id=$cart_id&cart_qty=$cart_qty&pid=$pid");
