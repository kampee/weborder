...
<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
	<td bgcolor="EEEEDD" height="20" colspan="2">
		<font face="Helvetica Condensed,Arial,verdana,sans-serif" size="2" color="#FF9900">
		&nbsp; <b>Change Password</b>
		</font>
	</td>
</tr>
...
<tr>
	...
	&nbsp; 
		...
		while ( $rowc = mysql_fetch_array( $resultc ) ) 
		{
			...
			{
				echo "<OPTION VALUE=\"$rowc[cur_code]\" SELECTED>$rowc[cur_sy]</OPTION>";
			}
			else
			{
				echo "<OPTION VALUE=\"$rowc[cur_code]\">$rowc[cur_sy]</OPTION>";
			}
		}
		?>
		</SELECT>
