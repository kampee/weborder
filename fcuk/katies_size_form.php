...
<table cellpadding="0" cellspacing="0" border="1" bordercolor="EEEEDD" bgcolor="F9F9F6">
<form action="katies_size_form.php?cart_id=<?php echo $cart_id; ?>&cart_qty=<?php echo $cart_qty; ?>&act=update" method="post">

<tr bordercolordark="#ffffff" bordercolorlight="silver" valign="middle">
	<td bgcolor="#CCFFC" height="20">
...
<tr bordercolordark="#ffffff" bordercolorlight="silver" valign="middle">
	<td bgcolor="#CC0000" height="20">
		...
		if ($fchk>0) 
		{
			include("katies_size_form_edit.php");
		}
		else
		{
			include("katies_size_form_add.php");
		}
		?>
...
if($act=="update")
{
	...
	if ($fchk==1) 
	{
		for($i=0; $i<12; $i++)
		{
		$query="UPDATE $wb_tbl_slse SET sl_num='$sl_num[$i]',sl_usa='$sl_usa[$i]',sl_qty='$sl_qty[$i]' WHERE sl_cartid='$cart_id' and sl_no='$sl_no[$i]'";
	...
	AlertMsg("Size label variables has been updated.","katies_size_form.php?cart_id=$cart_id&cart_qty=$cart_qty");
