...
if($session_cid==8)	
{
	...
	{
		case "en":
			define(_systitle,"CLW Web Ordering System");				
			break;
		case "fr":
			define(_systitle,"CLW Syste'me de commande en ligne 3.0");
			break;
		default:
			define(_systitle,"CLW Web Ordering System");
...
<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
	<td bgcolor="EEEEDD" height="50" align="center">
		<font face="Helvetica Condensed,Arial,verdana,sans-serif" size="5" color="#CC0000">
