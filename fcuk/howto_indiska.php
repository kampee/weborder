...
<u>Putting products into your Cart</u><br>
...
3.	Click on 'ADD TO CART' button. You will automatically be directed to the VIEW CART page wherein you will se the calculated amount of your order.<br>
<br>
...
All <b><?php echo $session_cname; ?></b> factories/vendors are requested to pay before shipment to CLW. We have provided 2 methods for accepting your payments.<br>
1. Telegraphic Transfer (T/T) : After confirming the order with us and after the goods are shipped, we will send you the Monthly Statement for money collection. Kindly make T/T to our designated Bank Account only. The credit terms will start counting from the shipment date. All the bank charges have to be responsible by the buyers. 

<br>
2. Credit Cards : We have provided the Secured website for your credit card payment method. Just simply fill out your card information required by our system. After confirmation of the transaction, we will proceed with your orders accordingly. All the credit card payment charges will have to be responsibility of the buyer.
...
We don't set minimum order for you because we offer Indiska as the annual package pricing. However, please order 5% overage quantity enough to cover shortage problem. All prices are based on Ex-Works , Bangalore, India . Factories should place order with us directly to our Web Ordering System or communicate only with our Headquarters in Bangkok for ordering, follow up, and all other necessary processes. Payment should be made to our bank account in Bangkok, Thailand or in Hong Kong.
<br>
<br>
