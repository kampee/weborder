...
<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
	<td bgcolor="white" >
		...
		<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
			...
			<td bgcolor="white" height="20">
				...
				<?php
					...
					$queryp="select * from $wb_tbl_product where cid='$session_cid' ";
		...
		<tr bordercolordark="#ffffff" bordercolorlight="gray" valign="middle">
			...
			<td bgcolor="white" height="20">
				<font face="Helvetica Condensed,Arial,verdana,sans-serif" size="2">
				&nbsp; <INPUT TYPE="text" NAME="stock_type" value="<?php echo $stock_type; ?>" size="2" <?php echo $opt_type; ?> maxlength="1">&nbsp; <b>O</b>=Openning(+) &nbsp; <b>R</b>=Receive(+) &nbsp; <b>I</b>=Issue(-) &nbsp; <b>A</b>=Adjust(+/-)
				</font>
			</td>
		</tr>
